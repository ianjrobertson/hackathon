            ...
            <div className="flex items-center justify-center min-h-screen">
                <form className="flex flex-col bg-primary text-secondary p-8 rounded-lg shadow-lg" onSubmit={handleSubmit}>
                    ...
                    <div className="mb-4">
                        ...
                        <input type="text" className="bg-accent border rounded-md text-primary text-base px-2 py-1 w-full" id="username" name="username" required />
                    </div>
                    <div className="mb-4">
                        <label htmlFor="password" className="block text-lg mb-2">Password</label>
                        <input type="password" className="bg-accent border rounded-md text-primary text-base px-2 py-1 w-full" id="password" name="password" required />
                    </div>
                    <div className="mb-4">
